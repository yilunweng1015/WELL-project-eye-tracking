...
created <- mapply(convert, xls, gsub("xlsx", "csv", xls)) # convert to csv format
unlink(xls) # delete all xlsx files
...
eyeinfo <- read.csv("~/Desktop/well_project/trial_info1.csv")
...
write.csv(alldata,"well_001_all.csv",row.names=FALSE)
